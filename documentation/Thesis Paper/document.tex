...
%TODO Explain here that we want to focus on a microservices design. and that this is the most defining part of this thesis.

\subsection{Existing systems}
%TODO More detail needs to be added.
...
\\\\
Once we specified these services with the correct annotation, they can be used in the business logic.
